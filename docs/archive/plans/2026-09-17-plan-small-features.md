...
- [ ] **Step 1: 실패하는 테스트** — 스펙의 AC 6개를 그대로 옮긴다
- [ ] **Step 2: 실패 확인**
- [ ] **Step 3: 구현.** 단위별 어미가 다르다 — 무게는 「더/덜 썼습니다」, 온도는
      「높게/낮게 내렸습니다」, 시간은 「빨리/늦게 끝났습니다」
- [ ] **Step 4: `RecipeComparison`에 붙인다.** `[data-diff-text]`를 단다
- [ ] **Step 5: 모바일 폭에서 행이 두 줄이 되는지 확인**(스펙의 「열어둔 결정」)
- [ ] **Step 6: 전체 초록 + 커밋**
